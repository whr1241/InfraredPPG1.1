...
LastEditTime: 2022-07-06 21:41:50
FilePath: \InfraredPPG1.1\2008Green.py
Description: Green方法
'''
import time
import numpy as np
...
if __name__ == '__main__':
    ...
    video_path = r'I:\WHR\Dataset\1-Myself\5-haoran\video\subject1.0'
    ...
    while j <= end_index:
        ...
        # frame = cv2.imread(video_path + r'\test{}.pgm'.format(j))  # 三通道
